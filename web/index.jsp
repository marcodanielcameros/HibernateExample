						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="paterno" id="email"  placeholder="Escribe tu  Apellido Paterno"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="materno" id="username"  placeholder="Escribe tu Apellido Materno"/>
								</div>
							</div>
						</div>
